...
public final class MigrationRandomPolicy {
  ...
  public static void main(String[] args) {
    new MigrationRandomPolicy();
  }

  private MigrationRandomPolicy() {
    ...
    try {
      ...
      csv.setPrintStream(new PrintStream(new java.io.File("results/migration_random_policy.csv")));
      ...
      powerCsv.setPrintStream(new PrintStream(new java.io.File("results/migration_random_power.csv")));
  ...
  private void exportPowerConsumptionToCsv(CsvTable csv) {
    csv.setTitle("Power Consumption Data - Random Migration Policy");
